...
path_model='D:\\Drone_AIMS_Scratch\\ann.pth'
scaler_path='D:\\Drone_AIMS_Scratch\\scaler_ann.pkl'
...
while True:
    ...
    if result.multi_hand_landmarks:
        ...
        prediction=gModel(torch.tensor(data_pt,dtype=torch.float32).to(device))
        prediction=torch.argmax(prediction)
        cv2.putText(frame,dict_map_inv[prediction.item()],(50,50),cv2.FONT_HERSHEY_SIMPLEX,1,(0,255,0),2)
